...
$sql="INSERT INTO admin( FullName, AdminEmail, UserName, Password) VALUES(?,?,?,?)";
...
<input class="form-control" type="text" name="username" maxlength="10" autocomplete="off" required />
</div>
